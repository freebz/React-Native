// 예제 6-19 index.js는 최종 버전으로 ImagePickerIOS를 이용하여 사용자에게 이미지를 선택하도록 대화 상자를 보여준다
...
class PhotoBackdrop extends Component {
    ...
    _pickImage() {
	// 여기서는 안드로이드에서도 동작하는 서드파티 이미지 피커 모듈을 사용했다
	// https://github.com/marcshilling/react-native-image-picker#usage
